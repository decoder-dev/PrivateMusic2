...
`PrivateMusic-3.5.0-unsigned.ipa`. Push the contents of this directory to a GitHub
repository and run the `Build unsigned IPA` workflow.

Download the `PrivateMusic-3.5.0-unsigned` workflow artifact when the job
