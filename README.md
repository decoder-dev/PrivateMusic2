...
`PrivateMusic-2.9.4-unsigned.ipa`. Push the contents of this directory to a GitHub
repository and run the `Build unsigned IPA` workflow.

Download the `PrivateMusic-2.9.4-unsigned` workflow artifact when the job
